const CACHE='handsfree-real-v042';
const SHELL=['/','/real.css','/real.js','/core-adapter.js','/project-detail.js','/readiness-ui.js','/ko-ui.js','/queue-client.js','/manifest.webmanifest','/icon.svg','/app-version.json'];
