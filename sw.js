const CACHE='handsfree-real-v050';
const SHELL=['/','/real.css','/real.js','/core-adapter.js','/project-detail.js','/readiness-ui.js','/ko-ui.js','/queue-client.js','/input-ui.js','/project-input-bridge.js','/draft-manager.js','/read-experience.js','/manifest.webmanifest','/icon.svg','/app-version.json'];
