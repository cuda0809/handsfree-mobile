const CACHE='handsfree-real-v040';
const SHELL=['/','/real.css','/real.js','/core-adapter.js','/project-detail.js','/readiness-ui.js','/ko-ui.js','/manifest.webmanifest','/icon.svg','/app-version.json'];
